						...
						<div class="entry">
	                        ...
	                        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td>
									      <form>
									         <input type="text" class="textBox" name="shuliang" value="<s:property value="value.goodsQuantity"/>" size="4"/>
	        				...
	        				<table>
			                   ...
			                   <tr>
			                       ...
			                       <td width="110"><a href="<%=path %>/orderQueren.action" style="font-family: 微软雅黑;font-size: 18px;">订单确认</a></td>
			                   </tr>
			               </table>
						</div>
					</div>
