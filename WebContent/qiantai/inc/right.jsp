	  ...
	  <div id="sidebar">
			<ul>
				...
				<li>
					<h2>系统公告</h2>
					<p>
					   <MARQUEE onmouseover=this.stop() onmouseout=this.start() direction=up height=90 width=160 scrollAmount=3 scrollDelay=166 border="0">本站于2016年06月18日正式开通,欢迎大家访问本网站,各种信息应有尽有，欢迎各位浏览。</MARQUEE>
					</p>
				</li>
				<li>
					<h2>联系我们</h2>
