						...
						<div class="entry">
						    <form action="<%=path %>/addToCart.action" method="post" name="buy">
								<table width="100%" border="0">
								    ...
								    <tr>
								       <td align="left">菜品名称：<s:property value="#request.goods.goodsName"/><hr/></td>
								    </tr>
								    <tr>
								       <td align="left">餐馆信息：
								          <s:property value="#request.goods.dianpu.mingcheng"/>
								          <hr/>
								       </td>
								    </tr>
								    <tr>
								       <td align="left">菜品介绍:<s:property value="#request.goods.goodsMiaoshu" escape="false"/><hr/></td>
								    </tr>
								    <tr>
								       <td align="left">购买价格:<s:property value="#request.goods.goodsTejia"/><hr/></td>
								    </tr>
								    <tr>
								       <td align="left">订购数量：<input type="text" name="quantity" value="1" size="8" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/><hr/></td>
								    </tr>
								    <tr>
								       <td align="left">
								           ...
								           <input type="button" value="查看点评" onclick="pingjiaAll(<s:property value="#request.goods.goodsId"/>)" style="width: 140px;height: 30px;"/>
								       </td>
								    </tr>
								</table>
						    </form>
