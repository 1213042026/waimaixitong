...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function pingjiaDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/pingjiaDel.action?id="+id;
               }
           }
       </script>
	</head>
	...
	<body leftmargin="8" topmargin="8" background='<%=path %>/images/allbg.gif'>
			<table width="70%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA">
				...
				<c:forEach items="${requestScope.pingjiaList}" var="pingjia" varStatus="ss">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="删除" onclick="pingjiaDel(${pingjia.id})"/>
					</td>
				</tr>
				</c:forEach>
			</table>
